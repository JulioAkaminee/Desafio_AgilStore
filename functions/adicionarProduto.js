    ...
    rl.question("Categoria: ", (categoria) => {
      ...
      rl.question("Quantidade em estoque: ", (quantidade) => {
        ...
        if (
          ...
          console.log(
            `${estiloTerminal.fundoVermelho}Quantidade inválida! Use apenas números inteiros (ex: 1, 2, 10)${estiloTerminal.reset}`
          );
          return voltarMenu();
        }
        ...
        rl.question("Preço: ", (preco) => {
          ...
          if (isNaN(precoNumero) || precoNumero <= 0) {
            console.log(
              `${estiloTerminal.fundoVermelho}Preço inválido! Use números, ex: 30,5 ou 30.5${estiloTerminal.reset}`
            );
            return voltarMenu();
          }
